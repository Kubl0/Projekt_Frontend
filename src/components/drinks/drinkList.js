...
export default function DrinkList() {
    ...
    useEffect(() => {
        setFilteredDrinks(drinks.filter(drink => drink.name.toLowerCase().includes(search.toLowerCase())))
    ...
    return (
        <div className="drinkList">
            ...
            <input type="text" placeholder="Wyszukaj drinka" value={search} onChange={(e) => {setSearch(e.target.value)}}/>
